                        ...
                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                            <div class="btn-group" role="group">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="btnGroupDrop4">
                                    <li>
                                        <icon class="d-flex align-items-center gap-2 p-2 text-secondary icon-head ${data.sys_pk == 0 ? "hidde_control" : ""}" id="stage-notis" onclick="window.location.href='/!/vendesk/stage_notif/?stage=${data.sys_pk}'">
