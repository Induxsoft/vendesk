...
var controller = {
  ...
  save_pieline: function () {
    ...
    var uri = `${url}sales_pipeline/?pipeline_id=${pipeline_id.value}`; //`${url}crm/sales/pipeline/${pipeline_id.value}`;
  ...
  save_pieline_stages: function () {
    ...
    var uri = `${url}sales_pipeline/?pipeline_id=${idpipeline.value}&stage_id=`; //`${url}crm/sales/pipeline/${idpipeline.value}/stages/`;
  ...
  save_stage: function (id, sys_pk) {
    ...
    var uri = `${url}sales_pipeline/?pipeline_id=${idpipeline.value}&stage_id=${idstg}`; //`${url}crm/sales/pipeline/${idpipeline.value}/stages/${idstg}`;
    var data = data_pipeline;
  ...
  delete_stage_bd: function (id, sys_pk) {
    ...
    var uri = `${url}sales_pipeline/?pipeline_id=${idpipeline.value}&stage_id=${sys_pk}`; //`${url}crm/sales/pipeline/${idpipeline.value}/stages/${sys_pk}`;
    model.invoke_service(uri, null, function (data) {
